...
Do not write approved notes directly from `/llmzk-promote`. Durable notes are written only by `/llmzk-write-approved <candidate-review-file>` after the user reviews the candidate file.
